$(document).ready(function () {
    $(function () {
        $('#ReceiveImportPattern-Edit-Btn').on('click', function () {
...
function DeleteFunction(wid, patternCode) {
    if (!confirm('パターンコード: ' + patternCode + ' は削除します。よろしいですか？')) {
        //alert('not send');
        return false;
    } else {
        // alert('send');
        $.ajax({
            url: ROOT + '/M_ReceiveImportPattern/Delete',
            type: 'GET',
            dataType: 'json',
            data: { wid: wid, patternCode: patternCode},
            success: function (res) {

                //$('#modalediteusermanagament').modal('hide');
                //if (String(res.statusCode) == "true") {
                //    $('#iWarning').modal('show');
                //    $("#successcontent").html(res.mess);
                //}
                //else if (String(res.statusCode) == "false") {
                //    $('#iWarning').modal('show');
                //    $("#warningcontent").html(res.mess);
                //}
                //else if (String(res.statusCode) == "permissiondenied") {
